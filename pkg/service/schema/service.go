...
import (
	...
	schemalib "github.com/tavroi/ssi-sdk/schema"
	...
	"github.com/tavroi/ssi-service/internal/did"
...
func (s Service) GetSchema(request GetSchemaRequest) (*GetSchemaResponse, error) {
	...
	// TODO(gabe) support external schema resolution https://github.com/tavroi/ssi-service/issues/125
