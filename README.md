[![godoc ssi-service](https://img.shields.io/badge/godoc-ssi--service-blue)](https://github.com/tavroi/ssi-service)
[![go version 1.19.4](https://img.shields.io/badge/go_version-1.19.4-brightgreen)](https://go.dev/)
[![license Apache 2](https://img.shields.io/badge/license-Apache%202-black)](https://github.com/tavroi/ssi-service/blob/main/LICENSE)
[![issues](https://img.shields.io/github/issues/tavroi/ssi-service)](https://github.com/tavroi/ssi-service/issues)
![push](https://github.com/tavroi/ssi-service/workflows/ssi-service-ci/badge.svg?branch=main&event=push)
...
[collaboration repo](https://github.com/tavroi/collaboration). The SSI Service is a HTTP-API driven web service
that wraps the [ssi-sdk](https://github.com/tavroi/ssi-sdk). The core functionality of the SSIS includes,
...
view [CONTRIBUTING](https://github.com/tavroi/ssi-service/blob/main/CONTRIBUTING.md) for more information.
...
CI is managed via [GitHub Actions](https://github.com/tavroi/ssi-service/actions). Actions are triggered to run
...
or [issue](https://github.com/tavroi/ssi-service/issues) if you are interested in helping shape the future of the
project.
...
|--------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| [VISION](https://github.com/tavroi/ssi-service/blob/main/doc/VISION.md)               | Outlines the project vision                                                   |
| [SIPs](sip/README.md)                                                                      | Proposals for improving the SSI Service                                       |
| [VERSIONING](https://github.com/tavroi/ssi-service/blob/main/doc/VERSIONING.md)       | Project versioning strategy                                                   |
| [CODEOWNERS](https://github.com/tavroi/ssi-service/blob/main/CODEOWNERS)              | Outlines the project lead(s)                                                  |
| [CODE_OF_CONDUCT](https://github.com/tavroi/ssi-service/blob/main/CODE_OF_CONDUCT.md) | Expected behavior for project contributors, promoting a welcoming environment |
| [CONTRIBUTING](https://github.com/tavroi/ssi-service/blob/main/CONTRIBUTING.md)       | Developer guide to build, test, run, access CI, chat, discuss, file issues    |
| [GOVERNANCE](https://github.com/tavroi/ssi-service/blob/main/GOVERNANCE.md)           | Project governance                                                            |
| [SECURITY](https://github.com/tavroi/ssi-service/blob/main/SECURITY.md)               | Vulnerability and bug reporting                                               |
| [LICENSE](https://github.com/tavroi/ssi-service/blob/main/LICENSE)                    | Apache License, Version 2.0                                                   |
